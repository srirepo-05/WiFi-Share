...
<html>
<head>
    <title>My Attractive Webpage</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
    <h1>Welcome to File Share!</h1>
    <p>Scan the QR Code to Share your file.</p>
...
# converts the IP address into a QR code
url = pyqrcode.create(link)
# saves the QR code inform of svg
url.svg("myqr.svg", scale=8)
# opens the QR code image in the web browser
webbrowser.open('myqr.svg')

# Creating the HTTP request and serving the
# folder in the PORT 8010, and the QR code is generated
